  ...
  <section class="text-gray-600 overflow-hidden">
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-col text-center w-full mb-20">
        <h1 class="sm:text-4xl text-3xl font-medium mb-2 text-gray-900">Pricing</h1>
      ...
      <div class="flex flex-wrap -m-4">
        ...
        <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
          <div class="border-2 h-full p-6 rounded-lg border-gray-300 flex flex-col relative overflow-hidden">
            <h2 class="text-sm tracking-widest mb-1 font-medium">START</h2>
            <h1 class="text-5xl text-gray-900 pb-4 mb-4 border-b border-gray-200 leading-none">Free</h1>
            <p class="flex items-center text-gray-600 mb-2">
              <span class="w-4 h-4 mr-2 bg-gray-400 inline-flex items-center justify-center text-white rounded-full flex-shrink-0">
            ...
            <button class="flex items-center mt-auto text-white bg-gray-400 border-0 py-2 px-4 w-full focus:outline-none hover:bg-gray-500 rounded">
              Button
              <svg class="w-4 h-4 ml-auto" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
          <div class="border-2 h-full p-6 rounded-lg border-indigo-500 flex flex-col relative overflow-hidden">
            <span class="absolute right-0 top-0 bg-indigo-500 px-3 py-1 text-white tracking-widest text-xs rounded-bl">POPULAR</span>
            <h2 class="text-sm tracking-widest mb-1 font-medium">PRO</h2>
