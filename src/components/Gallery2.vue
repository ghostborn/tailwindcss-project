  ...
  <section class="text-gray-600">
    <div class="container px-5 py-24 mx-auto flex flex-wrap">
      <div class="lg:w-2/3 mx-auto">
        <div class="relative flex flex-wrap w-full bg-gray-100 py-32 px-10 mb-4">
          <img alt="" class="w-full object-cover h-full object-center block opacity-25 absolute mb-4 inset-0" src="https://dummyimage.com/820x340">
